...
import AWS.ACM.Types as ACMTypes
...
describeCertificate :: forall eff. ACM.Service -> ACMTypes.DescribeCertificateRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.DescribeCertificateResponse
describeCertificate (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
...
getCertificate :: forall eff. ACM.Service -> ACMTypes.GetCertificateRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.GetCertificateResponse
getCertificate (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getCertificate"
...
importCertificate :: forall eff. ACM.Service -> ACMTypes.ImportCertificateRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.ImportCertificateResponse
importCertificate (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
...
listCertificates :: forall eff. ACM.Service -> ACMTypes.ListCertificatesRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.ListCertificatesResponse
listCertificates (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
...
listTagsForCertificate :: forall eff. ACM.Service -> ACMTypes.ListTagsForCertificateRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.ListTagsForCertificateResponse
listTagsForCertificate (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listTagsForCertificate"
...
requestCertificate :: forall eff. ACM.Service -> ACMTypes.RequestCertificateRequest -> Aff (exception :: EXCEPTION | eff) ACMTypes.RequestCertificateResponse
requestCertificate (ACM.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "requestCertificate"
